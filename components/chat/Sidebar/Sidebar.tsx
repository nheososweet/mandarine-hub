...
//     disabled={disabled}
//     size="sm"
//     className="h-9 w-full bg-primary text-xs font-medium text-background hover:bg-primary/80 cursor-pointer"
//   >
...
//                   </p>
//                   <div
//                     className={`size-2 shrink-0 rounded-full ${getStatusColor(
//                       isEndpointActive
//                     )}`}
//                   />
//                 </motion.div>
  ...
  return (
    <div className="flex flex-col items-start gap-2">
      ...
      {isEditing ? (
        ...
        <div className="flex w-full items-center gap-1">
          <div
            className="relative flex h-9 w-full cursor-pointer items-center justify-between rounded-xl border border-primary/15 bg-accent p-3 uppercase transition-colors"
            onMouseEnter={() => setIsHovering(true)}
            onMouseLeave={() => setIsHovering(false)}
            onClick={() => setIsEditing(true)}
          >
          ...
          >
            <div
              className={`transition-transform ${isRotating ? "rotate-360" : ""
                }`}
              style={{
...
const Sidebar = ({
  ...
  return (
    <aside
      className="relative flex h-screen shrink-0 grow-0 flex-col overflow-hidden px-2 py-3 font-dmmono transition-all"
      style={{
    ...
    >
      ...
      <div
        className="w-60 space-y-5 transition-all"
        style={{
